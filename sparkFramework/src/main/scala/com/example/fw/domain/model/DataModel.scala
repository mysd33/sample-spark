 ...
 * @param partitions       @see [[Partitionable.partitions]]
 * @param schema          @see [[HavingSchema.schema]]
 * @param encoding        @see [[TextFormat.encoding]]
 * @param dateFormat      @see [[HavingDateFormat.dateFormat]]
 * @param timestampFormat @see [[HavingDateFormat.timestampFormat]]
 * @param compression     @see [[Compressable.compression]]
 * @tparam T データセットが扱うデータ型。RDDやDataFrame、Dataset等で扱う型パラメータと対応する。
 */
