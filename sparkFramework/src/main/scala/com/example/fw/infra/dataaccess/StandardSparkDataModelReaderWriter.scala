...
import com.example.fw.domain.dataaccess.{DataModelReaderWriterImpl, _}
import com.example.fw.domain.model.{CsvModel, DataModel, JsonModel, MultiFormatCsvModel, ParquetModel, TextLineModel, XmlModel, _}
import com.example.fw.infra.dataaccess.impl.{CsvReaderWriter, JsonReaderWriter, MultiFormatCsvReaderWriter, StandardParquetReaderWriter, TextLineFileReaderWriter, XmlReaderWriter, _}
...
trait StandardSparkDataModelReaderWriter extends DataModelReaderWriterImpl {
  /**
   * @see [[DataModelReaderWriterImpl.readToRDDImpl]]
  ...
  /**
   * @see [[DataModelReaderWriterImpl.readToDfImpl]]
   * @param input    入力ファイルのDataModel
   * @param sparkSession SparkSession
   * @return DataFrame
   */
  ...
  /**
   * @see [[DataModelReaderWriterImpl.writeFromRDDImpl]]
   * @param rdd        出力対象のRDD
  ...
  /**
   * @see [[DataModelReaderWriterImpl.writeFromDsDfImpl]]
